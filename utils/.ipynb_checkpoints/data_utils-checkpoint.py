...
def get_loader(args):
    ...
    if args.dataset == 'CUB_200_2011':
        ...
        test_transform=transforms.Compose([transforms.Resize((600, 600), Image.BILINEAR),
                                    ...
                                    transforms.ToTensor(),
                                    transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        # trainset = torchvision.datasets.ImageFolder(root=args.data_root+"/train", transform=train_transform)
        # testset = torchvision.datasets.ImageFolder(root=args.data_root+"/test", transform=test_transform)
